...
st.image("images/hemisphère-nord-temperature-250000.jpg")
st.image("images/hemisphère-nord-temperature-40000.jpg")
...
st.write("## Le Convoyeur")
st.image("images/convoyeur.jpg")
st.write("www.rtbf.be")

st.write("##### La circulation des courants océaniques dans l'Atlantique, qui contribuent à la régulation du climat mondial, est à son plus faible niveau en 1600 ans, en partie à cause du changement climatique.")
...
st.write("##### S'il est difficile de connaître avec certitude le rôle joué par le réchauffement climatique, le fait que l'AMOC soit resté faible et se soit affaibli au cours du 20e siècle, avec un déclin notable à partir de 1950 environ, est très certainement lié à des facteurs humains, estime-t-on.")

st.write("")
st.write("")
st.write("### La Terre Boule de Neige (env. -635 millions d'années).")
...
st.write("### Ou bien plutôt ça ?")
st.image("images/carte_pleistocene_glaciation_north_arizona_university_dr.jpg")
st.write("North Arizona University")

st.write("")
st.write("")

st.write("#### Tout au long de projet, nous avons remarqué que nous bénéficions d'un climat plutôt stable dû notamment à la géologie.")
st.write("#### Nous avons remarqué aussi que ces périodes de stabilité climatique s'achèvent régulièrement.")
st.write("#### L'Homo Sapiens a fait face à ces crises climatiques en inventant l'agriculture, les villes, le commerce par exemple.")
st.write("#### Ces crises climatiques ont été un facteur de développement, parfois à un coût humain exorbitant, mais notre espèce est toujours là.")
st.write("#### A l'heure actuelle nous naviguons en aveugle, espérons que nous aurons la volonté et la force de changer nos comportements à tous les niveaux de la population pour passer au travers de cette crise sans trop casser de verre.")
